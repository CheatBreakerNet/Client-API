...
from utils import get_all_servers, validate_logo, validate_discord_logo, validate_primary_background, validate_icon
...
def check_media(args: argparse.Namespace, current_errors: dict) -> dict:
    ...
    for server in servers:
        ...
        if all(len(errors) == 0 for errors in [icon_errors, logo_errors, discord_logo_errors, primary_background_errors]):
            continue
